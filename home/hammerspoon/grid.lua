...
--- ikjl: resize window
hs.hotkey.bind(mash, "c", function() hs.grid.resizeWindowShorter() end)
hs.hotkey.bind(mash, "t", function() hs.grid.resizeWindowTaller() end)
hs.hotkey.bind(mash, "h", function() hs.grid.resizeWindowThinner() end)
hs.hotkey.bind(mash, "n", function() hs.grid.resizeWindowWider() end)
...
--- ,: snap window to grid
hs.hotkey.bind(mash, "w", function() hs.grid.snap(getWin()) end)

--- space: maximize window
hs.hotkey.bind(mash, "space", function() hs.grid.maximizeWindow() end)

--- .: minimize window
hs.hotkey.bind(mash, "v", function() hs.grid.set(getWin(), '0,0 1x1'); end)
